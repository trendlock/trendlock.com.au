    ...
    <main class="center bg-black">
      <div class="vh-100 w-100 flex items-end cover ${background}">
        <div class="vh-100 flex flex-auto flex-column justify-center tc near-white ${easingGradient}">
          <h1>
            <img class="h3 h4-ns" src="/assets/title-glow.svg" alt="Trendlock consulting"/>
          </h1>
        </div>
      </div>
