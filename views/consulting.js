...
function view() {
  return html`
    <main class="center bg-black">
      <div class="vh-100 w-100 cover ${background}">
      ...
      <section class="center ml4 w-two-thirds-l tc f4-ns lh-copy pa3">
        <div>
      ...
      <section class="center ml4 w-75-l tc f5-ns lh-copy pa3 pb7">
        ...
        ${animateDeepDive.render(html`
          <div class="flex-l items-center mb6">
            <div class="w-third-l">
            ...
            <div class="ml4-ns w-two-thirds-l">
              <p class="tl">
